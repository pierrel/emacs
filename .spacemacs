...
before packages are loaded."
  ...
  (require 'gptel)
  (use-package gptel
    :custom (setq gptel-api-key "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"))
)
